...
<main role="main">
        <div class="jumbotron">
              ...
              <h1 class="display-4"  style="blue;"  >Liste des étudiants</h1>
              <b><h5 style="color:red;">Cliquer sur le bouton afin de supprimer l'etudiant!</h5></b>
...
<div class="table table-striped table-hover ">
   <table class="table table-striped table-hover " >
    ...
    if($reponse->rowCount()>0){
        ...
        if(count($row)>0){
           echo" <tr><th> CIN</th><th> Nom </th> <th> Prénom </th><th>adresse</th><th> Email</th><th>Classe </th><th>action</th></tr>";
        ...
        { 
          ...
          echo "<tr><td>$cin</td><td>$nom</td><td>$prenom</td> <td>$adresse</td> <td>$email</td><td>$classe</td>";
            echo "<td>";
            echo"<a href='supprimer.php?cin=$cin' onclick='return confirm(\"etre sur!!\");' class='btn btn-danger'>supprimer </a>";
